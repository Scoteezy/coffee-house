...
const About = () => {
  return (
    <section className="wrapper text-center flex flex-center flex-col text-black my-24 ">
      <h2 className="h2-regular">About Us</h2>
      <Beans color="black" />
      <div className="max-w-[600px]">
        <p className="p-regular-14 block">
        ...
        <p className="p-regular-14 mt-3 block">
